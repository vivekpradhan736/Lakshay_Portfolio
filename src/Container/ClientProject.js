          ...
          <div className="left">
            ...
            <div className="projectDetail">
              <div className="feature_1_2">
                <h1 className="H1">
                  Easy installation through NPM <div className="border"></div>
                </h1>
                <h1 className="H1">
                  Modular components <div className="border"></div>
                </h1>
              </div>
              <div className="feature_3_4">
                <h1 className="H1">
                  Highly customizable with CSS <div className="border"></div>
                </h1>
                <h1 className="H1">
                  Beautifully designed components <div className="border"></div>
                </h1>
              </div>
            </div>
          ...
          <div className="left2">
            ...
            <div className="projectDetail2">
              <div className="feature_1_22">
                <h1 className="h1">
                  Easy installation through NPM <div className="border2"></div>
                </h1>
                <h1 className="h1">
                  Modular components <div className="border2"></div>
                </h1>
              </div>
              <div className="feature_3_42">
                <h1 className="h1">
                  Highly customizable with CSS <div className="border2"></div>
                </h1>
                <h1 className="h1">
          ...
          <div className="projectCard" key={index}>
            <div className="left">
              ...
              <div className="tech_live">
                ...
                <a href={item.link} className="liveLink">
